...
pipeline {
    ...
    parameters {
        string(name: 'HARBOR_HOST', defaultValue: '192.168.130.23', description: 'harbor仓库地址')
        string(name: 'DOCKER_IMAGE', defaultValue: 'sxczlczsm/pipeline-demo', description: 'docker镜像名')
